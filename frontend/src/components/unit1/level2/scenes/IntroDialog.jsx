export default function IntroDialog({
    ...
    return (
        ...
        >
            ...
            <div className="mt-1">
                {title && (
                    <h2 className="mb-1 text-lg font-black text-white md:text-2xl">
                        {title}
                    </h2>
                )}

                <p className="min-h-[72px] text-base leading-start text-white md:text-lg">
                    {text}
                </p>
            </div>
            ...
            <div className="mt-4 flex items-center justify-between gap-4">
                ...
                <button
                    type="button"
                    onClick={onNext}
                    className="button-with-icon-introScenes button-purple icon-right"
                >
