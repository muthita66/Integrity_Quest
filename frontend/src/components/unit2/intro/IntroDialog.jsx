export default function IntroDialog({
    ...
    return (
        ...
        >
            ...
            <div className="mt-1">
                {title && (
                    <h2 className="mb-1 text-md font-black md:text-2xl drop-shadow-md">
                        {title}
                    </h2>
                )}

                <p className="min-h-[72px] text-base leading-normal md:text-lg whitespace-pre-wrap drop-shadow-md">
                    {text}
                </p>
            </div>
